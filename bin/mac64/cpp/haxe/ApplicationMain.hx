...
class ApplicationMain {
	...
	public static function main () {
		...
		telemetryConfig.app_name = "HaxePunk_Project";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "HaxePunk_Project", null, { width: 750, height: 450 });
			
			
			#if openfl
			var stage = wx.NMEStage.create (frame, null, null, { width: 750, height: 450 });
			#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		#if (js && html5)
		#if (munit || utest)
		openfl.Lib.embed (null, 750, 450, "null");
		#end
		#else
		create ();
		#end
