...
{
HX_STACK_FRAME("openfl._legacy.AssetData","new",0xeaf2b3a8,"openfl._legacy.AssetData.new","openfl/_legacy/Assets.hx",1594,0x9276b055)
HX_STACK_THIS(this)
{
}
;
...
bool AssetData_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void AssetData_obj::__register()
{
	...
	__mClass->mSetStaticField = &AssetData_obj::__SetStatic;
