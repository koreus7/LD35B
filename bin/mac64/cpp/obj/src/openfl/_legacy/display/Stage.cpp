		...
		if (  ( _switch_1==HX_HCSTRING("axisMove","\x52","\x90","\xf4","\x8f"))){
			...
			if ((tmp6)){
				...
				if ((tmp9)){
					...
					HX_STACK_LINE(725)
					::openfl::events::JoystickEvent tmp14 = ::openfl::events::JoystickEvent_obj::__new(tmp10,false,false,event->__Field(HX_HCSTRING("id","\xdb","\x5b","\x00","\x00"), hx::paccDynamic ),(int)0,tmp11,tmp12,tmp13);		HX_STACK_VAR(tmp14,"tmp14");
					HX_STACK_LINE(725)
					joystickEvent = tmp14;
					HX_STACK_LINE(726)
				...
				HX_STACK_LINE(732)
				::openfl::events::JoystickEvent tmp11 = ::openfl::events::JoystickEvent_obj::__new(tmp7,false,false,event->__Field(HX_HCSTRING("id","\xdb","\x5b","\x00","\x00"), hx::paccDynamic ),(int)0,tmp8,tmp9,tmp10);		HX_STACK_VAR(tmp11,"tmp11");
				HX_STACK_LINE(732)
				joystickEvent = tmp11;
				HX_STACK_LINE(733)
				joystickEvent->axis = data->copy();
			...
			HX_STACK_LINE(738)
			::openfl::events::JoystickEvent tmp1 = ::openfl::events::JoystickEvent_obj::__new(type,false,false,event->__Field(HX_HCSTRING("id","\xdb","\x5b","\x00","\x00"), hx::paccDynamic ),event->__Field(HX_HCSTRING("code","\x2d","\xb1","\xc4","\x41"), hx::paccDynamic ),event->__Field(HX_HCSTRING("x","\x78","\x00","\x00","\x00"), hx::paccDynamic ),event->__Field(HX_HCSTRING("y","\x79","\x00","\x00","\x00"), hx::paccDynamic ),null());		HX_STACK_VAR(tmp1,"tmp1");
			HX_STACK_LINE(738)
			joystickEvent = tmp1;
		}
			...
			HX_STACK_LINE(773)
			::openfl::events::JoystickEvent tmp5 = ::openfl::events::JoystickEvent_obj::__new(type,false,false,event->__Field(HX_HCSTRING("id","\xdb","\x5b","\x00","\x00"), hx::paccDynamic ),event->__Field(HX_HCSTRING("code","\x2d","\xb1","\xc4","\x41"), hx::paccDynamic ),x,y,null());		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(773)
			joystickEvent = tmp5;
		}
		else  {
			HX_STACK_LINE(815)
			::openfl::events::JoystickEvent tmp1 = ::openfl::events::JoystickEvent_obj::__new(type,false,false,event->__Field(HX_HCSTRING("id","\xdb","\x5b","\x00","\x00"), hx::paccDynamic ),event->__Field(HX_HCSTRING("code","\x2d","\xb1","\xc4","\x41"), hx::paccDynamic ),null(),null(),null());		HX_STACK_VAR(tmp1,"tmp1");
			HX_STACK_LINE(815)
			joystickEvent = tmp1;
		}
;
;
		HX_STACK_LINE(819)
		::openfl::events::JoystickEvent tmp1 = joystickEvent;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(819)
...
Void Stage_obj::__onKey( Dynamic event,::String type){
{
		...
		if ((tmp2)){
			...
			if ((tmp26)){
				...
				HX_STACK_LINE(856)
				int tmp28 = ::openfl::_legacy::display::Stage_obj::efCtrlDown;		HX_STACK_VAR(tmp28,"tmp28");
				HX_STACK_LINE(856)
				...
				if ((tmp31)){
					HX_STACK_LINE(856)
					int tmp33 = flags;		HX_STACK_VAR(tmp33,"tmp33");
					HX_STACK_LINE(856)
					int tmp34 = ::openfl::_legacy::display::Stage_obj::efCommandDown;		HX_STACK_VAR(tmp34,"tmp34");
					HX_STACK_LINE(856)
				...
				if ((tmp33)){
					...
					HX_STACK_LINE(856)
					::String tmp36 = ::openfl::_legacy::events::KeyboardEvent_obj::KEY_DOWN;		HX_STACK_VAR(tmp36,"tmp36");
					HX_STACK_LINE(856)
				...
				if ((tmp34)){
					HX_STACK_LINE(856)
					tmp35 = (event->__Field(HX_HCSTRING("value","\x71","\x7f","\xb8","\x31"), hx::paccDynamic ) == (int)70);
				}
				else{
					HX_STACK_LINE(856)
					tmp35 = false;
				...
				if ((tmp35)){
					HX_STACK_LINE(859)
					::openfl::display::StageDisplayState tmp36 = this->get_displayState();		HX_STACK_VAR(tmp36,"tmp36");
					HX_STACK_LINE(859)
					bool tmp37 = (tmp36 == ::openfl::display::StageDisplayState_obj::NORMAL);		HX_STACK_VAR(tmp37,"tmp37");
					HX_STACK_LINE(859)
					if ((tmp37)){
						HX_STACK_LINE(861)
