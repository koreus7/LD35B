...
Void TextureBase_obj::__construct(::openfl::_legacy::gl::GLTexture glTexture,hx::Null< int >  __o_width,hx::Null< int >  __o_height)
{
...
hx::ObjectPtr< TextureBase_obj > TextureBase_obj::__new(::openfl::_legacy::gl::GLTexture glTexture,hx::Null< int >  __o_width,hx::Null< int >  __o_height)
{  hx::ObjectPtr< TextureBase_obj > _result_ = new TextureBase_obj();
	_result_->__construct(glTexture,__o_width,__o_height);
	return _result_;}
...
Void TextureBase_obj::dispose( ){
{
		...
		HX_STACK_LINE(32)
		::openfl::_legacy::gl::GL_obj::lime_gl_delete_texture(tmp1);
		HX_STACK_LINE(32)
		texture->invalidate();
	}
return null();
