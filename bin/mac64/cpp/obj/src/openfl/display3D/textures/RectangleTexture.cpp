...
Void RectangleTexture_obj::__construct(::openfl::_legacy::gl::GLTexture glTexture,bool optimize,int width,int height)
{
...
hx::ObjectPtr< RectangleTexture_obj > RectangleTexture_obj::__new(::openfl::_legacy::gl::GLTexture glTexture,bool optimize,int width,int height)
