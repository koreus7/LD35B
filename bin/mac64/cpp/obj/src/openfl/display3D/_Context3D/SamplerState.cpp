...
{
HX_STACK_FRAME("openfl.display3D._Context3D.SamplerState","new",0xe10565af,"openfl.display3D._Context3D.SamplerState.new","openfl/display3D/Context3D.hx",1040,0xc899cbb9)
HX_STACK_THIS(this)
{
}
;
...
bool SamplerState_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void SamplerState_obj::__register()
{
	...
	__mClass->mSetStaticField = &SamplerState_obj::__SetStatic;
