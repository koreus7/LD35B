...
Void IndexBuffer3D_obj::__construct(::openfl::_legacy::gl::GLBuffer glBuffer,int numIndices)
{
...
hx::ObjectPtr< IndexBuffer3D_obj > IndexBuffer3D_obj::__new(::openfl::_legacy::gl::GLBuffer glBuffer,int numIndices)
{  hx::ObjectPtr< IndexBuffer3D_obj > _result_ = new IndexBuffer3D_obj();
	_result_->__construct(glBuffer,numIndices);
	return _result_;}
