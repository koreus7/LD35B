...
Void Program3D_obj::__construct(::openfl::_legacy::gl::GLProgram program)
{
...
hx::ObjectPtr< Program3D_obj > Program3D_obj::__new(::openfl::_legacy::gl::GLProgram program)
{  hx::ObjectPtr< Program3D_obj > _result_ = new Program3D_obj();
	_result_->__construct(program);
	return _result_;}
...
Void Program3D_obj::dispose( ){
{
		...
		HX_STACK_LINE(24)
		::openfl::_legacy::gl::GL_obj::lime_gl_delete_program(tmp1);
		HX_STACK_LINE(24)
		program->invalidate();
	}
return null();
