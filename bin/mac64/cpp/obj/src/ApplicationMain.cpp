...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(29)
		::openfl::_legacy::Lib_obj::setPackage(HX_HCSTRING("","\x00","\x00","\x00","\x00"),HX_HCSTRING("Main","\x59","\x64","\x2f","\x33"),HX_HCSTRING("com.example.app","\xb0","\x42","\x86","\x72"),HX_HCSTRING("1.0.0","\xb5","\xd1","\x2e","\x55"));
		HX_STACK_LINE(133)
		...
		HX_STACK_LINE(52)
		::openfl::_legacy::Lib_obj::create( Dynamic(new _Function_1_1()),(int)750,(int)450,(int)60,(int)3355443,tmp22,HX_HCSTRING("HaxePunk_Project","\x22","\xf1","\x67","\x78"),null(),null());
	}
return null();
}
