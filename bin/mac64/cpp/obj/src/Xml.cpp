...
{
HX_STACK_FRAME("Xml","new",0x2e496e29,"Xml.new","/usr/lib/haxe/std/Xml.hx",316,0xf01ffe48)
HX_STACK_THIS(this)
...
::String Xml_obj::get( ::String att){
	HX_STACK_FRAME("Xml","get",0x2e441e5f,"Xml.get","/usr/lib/haxe/std/Xml.hx",166,0xf01ffe48)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("Xml","set",0x2e4d396b,"Xml.set","/usr/lib/haxe/std/Xml.hx",177,0xf01ffe48)
		HX_STACK_THIS(this)
		HX_STACK_ARG(att,"att")
...
bool Xml_obj::exists( ::String att){
	HX_STACK_FRAME("Xml","exists",0x446683b3,"Xml.exists","/usr/lib/haxe/std/Xml.hx",199,0xf01ffe48)
	HX_STACK_THIS(this)
	HX_STACK_ARG(att,"att")
	HX_STACK_LINE(200)
	int tmp = this->nodeType;		HX_STACK_VAR(tmp,"tmp");
...
Dynamic Xml_obj::elements( ){
	HX_STACK_FRAME("Xml","elements",0x0310ffce,"Xml.elements","/usr/lib/haxe/std/Xml.hx",229,0xf01ffe48)
	HX_STACK_THIS(this)
	HX_STACK_LINE(230)
	{
		HX_STACK_LINE(230)
...
::Xml Xml_obj::firstElement( ){
	HX_STACK_FRAME("Xml","firstElement",0xc103a583,"Xml.firstElement","/usr/lib/haxe/std/Xml.hx",256,0xf01ffe48)
	HX_STACK_THIS(this)
	HX_STACK_LINE(257)
	{
		HX_STACK_LINE(257)
...
{
		HX_STACK_FRAME("Xml","addChild",0x3e639952,"Xml.addChild","/usr/lib/haxe/std/Xml.hx",272,0xf01ffe48)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(273)
		{
...
bool Xml_obj::removeChild( ::Xml x){
	HX_STACK_FRAME("Xml","removeChild",0x9bd39581,"Xml.removeChild","/usr/lib/haxe/std/Xml.hx",285,0xf01ffe48)
	HX_STACK_THIS(this)
	HX_STACK_ARG(x,"x")
	HX_STACK_LINE(286)
	{
...
::Xml Xml_obj::parse( ::String str){
	HX_STACK_FRAME("Xml","parse",0x8a44f23c,"Xml.parse","/usr/lib/haxe/std/Xml.hx",43,0xf01ffe48)
...
::Xml Xml_obj::createElement( ::String name){
	HX_STACK_FRAME("Xml","createElement",0x97359a29,"Xml.createElement","/usr/lib/haxe/std/Xml.hx",104,0xf01ffe48)
...
::Xml Xml_obj::createPCData( ::String data){
	HX_STACK_FRAME("Xml","createPCData",0x3cc9ead0,"Xml.createPCData","/usr/lib/haxe/std/Xml.hx",113,0xf01ffe48)
...
::Xml Xml_obj::createCData( ::String data){
	HX_STACK_FRAME("Xml","createCData",0xaf49365a,"Xml.createCData","/usr/lib/haxe/std/Xml.hx",122,0xf01ffe48)
	HX_STACK_ARG(data,"data")
	HX_STACK_LINE(123)
...
::Xml Xml_obj::createComment( ::String data){
	HX_STACK_FRAME("Xml","createComment",0x125165cc,"Xml.createComment","/usr/lib/haxe/std/Xml.hx",131,0xf01ffe48)
	HX_STACK_ARG(data,"data")
	HX_STACK_LINE(132)
...
::Xml Xml_obj::createDocType( ::String data){
	HX_STACK_FRAME("Xml","createDocType",0x696de8bf,"Xml.createDocType","/usr/lib/haxe/std/Xml.hx",140,0xf01ffe48)
	HX_STACK_ARG(data,"data")
	HX_STACK_LINE(141)
...
::Xml Xml_obj::createProcessingInstruction( ::String data){
	HX_STACK_FRAME("Xml","createProcessingInstruction",0x632a1f28,"Xml.createProcessingInstruction","/usr/lib/haxe/std/Xml.hx",149,0xf01ffe48)
	HX_STACK_ARG(data,"data")
	HX_STACK_LINE(150)
...
::Xml Xml_obj::createDocument( ){
	HX_STACK_FRAME("Xml","createDocument",0xcf00030e,"Xml.createDocument","/usr/lib/haxe/std/Xml.hx",158,0xf01ffe48)
	HX_STACK_LINE(159)
