...
class HXCPP_CLASS_ATTRIBUTES  IndexBuffer3D_obj : public hx::Object{
	public:
		...
		IndexBuffer3D_obj();
		Void __construct(::openfl::_legacy::gl::GLBuffer glBuffer,int numIndices);

	public:
		inline void *operator new( size_t inSize, bool inContainer=true,const char *inName="openfl.display3D.IndexBuffer3D")
			{ return hx::Object::operator new(inSize,inContainer,inName); }
		static hx::ObjectPtr< IndexBuffer3D_obj > __new(::openfl::_legacy::gl::GLBuffer glBuffer,int numIndices);
