...
class HXCPP_CLASS_ATTRIBUTES  VertexBuffer3D_obj : public hx::Object{
	public:
		...
		VertexBuffer3D_obj();
		Void __construct(::openfl::_legacy::gl::GLBuffer glBuffer,int numVertices,int data32PerVertex);
	...
	public:
		...
		static hx::ObjectPtr< VertexBuffer3D_obj > __new(::openfl::_legacy::gl::GLBuffer glBuffer,int numVertices,int data32PerVertex);
