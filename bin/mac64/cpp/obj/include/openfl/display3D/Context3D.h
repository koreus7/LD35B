...
class HXCPP_CLASS_ATTRIBUTES  Context3D_obj : public hx::Object{
	...
	public:
		...
		virtual Void drawToBitmapData( ::openfl::_legacy::display::BitmapData destination);
		...
		virtual Void setGLSLProgramConstantsFromByteArray( ::String locationName,::openfl::_legacy::utils::ByteArray data,hx::Null< int >  byteArrayOffset);
		...
		virtual Void setProgramConstantsFromByteArray( ::openfl::display3D::Context3DProgramType programType,int firstRegister,int numRegisters,::openfl::_legacy::utils::ByteArray data,int byteArrayOffset);
		...
		virtual Void setScissorRectangle( ::openfl::_legacy::geom::Rectangle rectangle);
