...
class HXCPP_CLASS_ATTRIBUTES  TextureBase_obj : public ::openfl::_legacy::events::EventDispatcher_obj{
	public:
		...
		TextureBase_obj();
		Void __construct(::openfl::_legacy::gl::GLTexture glTexture,hx::Null< int >  __o_width,hx::Null< int >  __o_height);
	...
	public:
		...
		static hx::ObjectPtr< TextureBase_obj > __new(::openfl::_legacy::gl::GLTexture glTexture,hx::Null< int >  __o_width,hx::Null< int >  __o_height);
