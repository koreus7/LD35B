...
class HXCPP_CLASS_ATTRIBUTES  RectangleTexture_obj : public ::openfl::display3D::textures::TextureBase_obj{
	public:
		...
		Void __construct(::openfl::_legacy::gl::GLTexture glTexture,bool optimize,int width,int height);
	...
	public:
		...
		static hx::ObjectPtr< RectangleTexture_obj > __new(::openfl::_legacy::gl::GLTexture glTexture,bool optimize,int width,int height);
