...
class HXCPP_CLASS_ATTRIBUTES  CubeTexture_obj : public ::openfl::display3D::textures::TextureBase_obj{
	public:
		...
		CubeTexture_obj();
		Void __construct(::openfl::_legacy::gl::GLTexture glTexture,int size);
	...
	public:
		...
		static hx::ObjectPtr< CubeTexture_obj > __new(::openfl::_legacy::gl::GLTexture glTexture,int size);
