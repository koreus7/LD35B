...
class HXCPP_CLASS_ATTRIBUTES  __ASSET__font_04b_03___ttf_obj : public ::openfl::_legacy::text::Font_obj{
	public:
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=true,const char *inName="__ASSET__font_04b_03___ttf")
			{ return hx::Object::operator new(inSize,inContainer,inName); }
		static hx::ObjectPtr< __ASSET__font_04b_03___ttf_obj > __new(::String __o_filename,::openfl::_legacy::text::FontStyle style,::openfl::_legacy::text::FontType type);
		...
		::String __ToString() const { return HX_HCSTRING("__ASSET__font_04b_03___ttf","\xeb","\x6e","\x20","\x97"); }
