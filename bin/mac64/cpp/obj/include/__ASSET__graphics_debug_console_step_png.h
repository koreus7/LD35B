...
class HXCPP_CLASS_ATTRIBUTES  __ASSET__graphics_debug_console_step_png_obj : public ::openfl::_legacy::display::BitmapData_obj{
	public:
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=true,const char *inName="__ASSET__graphics_debug_console_step_png")
		...
		::String __ToString() const { return HX_HCSTRING("__ASSET__graphics_debug_console_step_png","\x2e","\x27","\x4b","\x69"); }
